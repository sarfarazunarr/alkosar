                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            <img src="/logo.jpeg" alt="Alkosar Logo" className="h-12 w-12 rounded-full object-cover border-2 border-blue-500" />
                            <h3 className="text-xl font-bold font-display text-gray-900 dark:text-white">Alkosar Institute</h3>
                        </div>
